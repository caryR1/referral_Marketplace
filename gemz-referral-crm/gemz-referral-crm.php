...
define( 'GRC_DB_VERSION', '0.4.1' ); // bump this whenever schema changes; activator checks it.
...
require_once GRC_PLUGIN_DIR . 'public/class-grc-partner-dashboard.php';
